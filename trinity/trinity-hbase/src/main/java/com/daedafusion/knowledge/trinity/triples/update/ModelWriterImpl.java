 ...
 */
public class ModelWriterImpl extends AbstractWriter implements ModelWriter
{
    private static final Logger log = Logger.getLogger(ModelWriterImpl.class);

    public ModelWriterImpl()
    {
